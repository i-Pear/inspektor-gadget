...
require (
	...
	github.com/elastic/otel-profiling-agent v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/elastic/go-freelru v0.11.0 // indirect
...
replace github.com/elastic/otel-profiling-agent => /root/otel-profiling-agent/
