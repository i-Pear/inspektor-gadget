...
[gadget/stack_map.h](https://github.com/inspektor-gadget/inspektor-gadget/blob/main/include/gadget/stack_map.h).
...
} gadget_kernel_stack_trace_map SEC(".maps");
```
...
`gadget_kernel_stack_trace_map` and returns the stack id as the key.
